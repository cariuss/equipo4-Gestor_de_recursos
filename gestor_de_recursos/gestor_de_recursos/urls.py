"""
URL configuration for gestor_de_recursos project.
...
urlpatterns = [
    ...
    path('api', include('rest_framework.urls', namespace='rest_framework')),  # localhost ip/recursos/api/
]
